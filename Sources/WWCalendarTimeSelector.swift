...
internal class WWClock: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if showingHour {
            let textAttr : [NSAttributedStringKey : Any] = [NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): fontHour, NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): fontColorHour, NSAttributedStringKey(rawValue: NSAttributedStringKey.paragraphStyle.rawValue): paragraph]
            let textAttrHighlight : [NSAttributedStringKey : Any] = [NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): fontHourHighlight, NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): fontColorHourHighlight, NSAttributedStringKey(rawValue: NSAttributedStringKey.paragraphStyle.rawValue): paragraph]
            ...
            let textAttr : [NSAttributedStringKey : Any] = [NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): fontMinute, NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): fontColorMinute, NSAttributedStringKey(rawValue: NSAttributedStringKey.paragraphStyle.rawValue): paragraph]
            let textAttrHighlight : [NSAttributedStringKey : Any] = [NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): fontMinuteHighlight, NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): fontColorMinuteHighlight, NSAttributedStringKey(rawValue: NSAttributedStringKey.paragraphStyle.rawValue): paragraph]
